...
FW_VERSIONS = {
  ...
  CAR.MAZDA3: {
    (Ecu.eps, 0x730, None): [
      ...
      b'BHN1-3210X-L-00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
      b'K070-3210X-B-00\x00\x00\x00\x00\x00\x00\x00\x00\x00',	  
      b'K070-3210X-C-00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
      b'K070-3210X-D-00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
    ...
    (Ecu.fwdRadar, 0x764, None): [
      ...
      b'KB8C-67XA1-C\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',	
    ],
    (Ecu.abs, 0x760, None): [
